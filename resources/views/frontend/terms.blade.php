					...
					<div class="container">
						...
						<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
							...
							<ul class="nav navbar-nav navbar-right links-to-collaps">
								<li class="dropdown">
									<a href="http://flipapp.ir/fa#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><img src="./images/fa.png"> <span class="hidden-sm hidden-md hidden-lg">زبان</span></a>
									<ul class="dropdown-menu">
										<li class="lang">
											<a class="active" href="{{ route('faTerms') }}" title="فارسی"><img src="./images/fa.png"> فارسی</a>
										</li>
										<li class="lang">
											<a class="" href="{{ route('enTerms') }}" title="English"><img src="./images/en.png"> English</a>
										</li>
									</ul>
								</li>
						...
						<div class="col-md-8 col-md-push-2 clearfix">
							<div class="section-heading scrollpoint sp-effect3">
								...
								<br>
									...
									<div class="col-md-6">
									<img id="hwlahwlabrgwsguisgui" style="cursor:pointer" onclick="window.open(&quot;https://trustseal.enamad.ir/Verify.aspx?id=44600&amp;p=odshodshhwmbdrfsdrfs&quot;, &quot;Popup&quot;,&quot;toolbar=no, location=no, statusbar=no, menubar=no, scrollbars=1, resizable=0, width=580, height=600, top=30&quot;)" alt="" src="./images/logo.aspx">
									</div>
								</div>
															</div>
						</div>

...
<aside class="main-sidebar">
    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li class="{{ (str_contains(Request::url(), route('contacts.index'))) ? 'active' : '' }}"><a href="{{ route('contacts.index') }}"><i class='ion-paper-airplane'></i><span> @lang('admin/general.Contact')</span></a></li>

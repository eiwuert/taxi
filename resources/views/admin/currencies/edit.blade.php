...
@section('header')
@lang('admin/general.Currencies')
{!! Form::open(['action' => ['Admin\CurrencyController@destroy', $currency], 'method' => 'DELETE', 'style' => 'display: initial;']) !!}
...
<div class="row">
    <div class="col-xs-12">
        <div class="box box-solid">
            ...
            <!-- /.box-header -->
            <div class="box-body">
                {!! Form::model($currency, ['method' => 'PATCH', 'action' => ['Admin\CurrencyController@update', $currency], 'class' => 'form-horizontal']) !!}

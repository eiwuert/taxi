...
@section('header')
@lang('admin/general.Zone')
{!! Form::open(['action' => ['Admin\ZoneController@destroy', $zone], 'method' => 'DELETE', 'style' => 'display: initial;']) !!}
...
<li class="active"><i class="ion-cube"></i> @lang('admin/general.Zone') </li>
@endsection
@section('content')
<div class="row">
    <div class="col-xs-12">
        <div class="box box-solid">
            ...
            <!-- /.box-header -->
            <div class="box-body">
                {!! Form::model($zone, ['method' => 'PATCH', 'action' => ['Admin\ZoneController@update', $zone], 'class' => 'form-horizontal']) !!}
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        {!! Form::select('unit',  ['kilometer' => __('admin/general.kilometer'), 'mile' => __('admin/general.mile')], ['class' => 'form-control']) !!}
                    </div>
                </div>
                <div class="form-group">
